...
ActiveRecord::Schema[7.0].define(version: 2024_11_01_014945) do
  ...
  create_table "variant_attributes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["attribute_id"], name: "index_variant_attributes_on_attribute_id"
  ...
  add_foreign_key "variant_attributes", "attributes"
